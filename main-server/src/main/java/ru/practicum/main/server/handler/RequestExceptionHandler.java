...
import ru.practicum.main.server.exception.RequestCreationException;
import ru.practicum.main.server.exception.RequestStateUpdateException;
import ru.practicum.main.server.exception.RequestViolationException;
...
public class RequestExceptionHandler {
    ...
    public ResponseEntity<Object> requestConflictExceptionHandler(Exception e) {
    ...
    @ResponseStatus(HttpStatus.CONFLICT)
    public ResponseEntity<Object> requestViolationExceptionHandler(RequestViolationException e) {
        HttpStatus status = HttpStatus.CONFLICT;
