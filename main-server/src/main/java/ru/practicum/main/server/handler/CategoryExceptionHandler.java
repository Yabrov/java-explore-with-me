...
public class CategoryExceptionHandler {
    ...
    public ResponseEntity<Object> categoryNotFoundExceptionHandler(CategoryNotFoundException e) {
    ...
    public ResponseEntity<Object> categoryIsNotEmptyExceptionHandler(CategoryIsNotEmptyException e) {
